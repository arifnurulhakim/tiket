...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="{{route('welcome')}}"><img src="assets/img/dpmtelu.png" class="img-fluid" alt=""></a></h1>
            ...
            @csrf
              ...
              <div class="form-group">
                <label for="aspirasi">Aspirasi</label>
                  <textarea class="form-control" id="aspirasi" placeholder="Ketik aspirasi kamu disini.." name="aspirasi" value="{{old('aspirasi')}}" rows="10" required></textarea>
              </div>
              <div class="text-center">
                <button type="submit"  class="btn btn-primary" style="color=#37517e">Kirim Aspirasi</button>
